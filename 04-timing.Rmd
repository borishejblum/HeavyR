...
As its name indicates, this package allows you to compare execution timings even when they are very quick. Moreover, each benchmarked expression will be repeatedly evaluated a certain number of times, thus stabilizing the timing estimations.
