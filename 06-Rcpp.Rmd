...
For additional (at the cost of code readability), you can have a look at our optimized Armadillo C++ implementation in [`mvnpdfoptimC.cpp`](https://heavyr.borishejblum.science/AdvancedRcourse_dev_perf_files/mvnpdfoptimC.cpp).
