...
`Rcpp` (R-C-Plus-Plus) est un package qui facilite l'interface entre `C++` et `r fontawesome::fa("r-project")`. `r fontawesome::fa("r-project")` est un langage
...
> 
  5. Lorsque vous avez réussi à compiler votre fonction `invC` et qu'elle est accèssible depuis `r fontawesome::fa("r-project")`
