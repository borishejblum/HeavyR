...
More details are provided in the reference material on this subject: the book [*R packages*](https://r-pkgs.org/) by Hadley Wickham & Jennifer Bryan[^1], freely available online.
...
[R code](https://r-pkgs.org/code.html) section from Wickam & Bryan *R packages* (2023) [^1].

[^1]: *R Packages* (2^nd^ Edition) by Hadley Wickham, Jennifer Bryan. O'Reilly, 2023. ISBN: 9781098134945.
...
For more details on package documentation and `roxygen2` tags, see the [Object documentation](https://r-pkgs.org/man.html) secttion from Hadley Wickam *R packages* online book.
