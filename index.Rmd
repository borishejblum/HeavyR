...
author: "[Robin Genuer](https://robin.genuer.fr/) & [Boris Hejblum](https://borishejblum.science/)"
date: "`r Sys.Date()`"
...
To take this course, you will need to have the following softwares installed:
  ...
  - a *C++ compiler* (such as `gcc` or `clang` - native on UNIX systems, 
	...
	Mac users it may be necessary to install the macOS tool chain (namely Xcode Command Line Tools  and gfortran) used by `r fontawesome::fa("r-project")` as detailed  [here](http://thecoatlessprofessor.com/programming/r-compiler-tools-for-rcpp-on-os-x/))
