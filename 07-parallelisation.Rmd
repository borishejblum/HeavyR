# Parallélisation du code `r fontawesome::fa("r-project")`

## Introduction à l'execution parallèle sous `r fontawesome::fa("r-project")`
...
est inclus directement dans `r fontawesome::fa("r-project")` et permet de démarrer et d'arrêter un "cluster"
...
## Première fonction parallèle en `r fontawesome::fa("r-project")`
...
tâches individuelles sont trop rapides, `r fontawesome::fa("r-project")` va passer plus de temps à
...
Pour un utilisateur averti de `r fontawesome::fa("r-project")`, une telle opération se programme facilement 
...
travailleurs. Il s'appuie sur une implémentation des itérateurs en `r fontawesome::fa("r-project")`. 
